...
button = tk.Button(frame, text="Select Directory", bg='white', command=button_main)
button.place(relwidth=0.25, relheight=1)
labelbottom = tk.Label(frame, text="Select the directory containing images to clean", bg='blue', fg="white")
labelbottom.place(relx=0.25, relheight=1, relwidth=0.75)
title_frame = tk.Frame(root, bg='#2103a8', bd=10)
title_frame.place(relx=0.5, rely=0.05, relwidth=0.75, relheight=0.1, anchor='n')
labeltitle = tk.Label(title_frame, text="Cleaned files are outputted to <SOURCE>/cleaned", bg='#2103a8', fg="white")
...
background_image = tk.PhotoImage(file= '/home/josh/massAnon/back.png')
print(background_image['file'])
background_label = tk.Label(upper_frame, image=background_image ,bg='#2103a8')
print(background_label['image'])
background_label.place(x=0, y=0, relwidth=1, relheight=1, )
infolabel = tk.Label(root, text="Select your files ", fg='#2103a8', bg='white', font=('Modern', 8))
